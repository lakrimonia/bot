...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="bot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" TelegramBot %CMD_LINE_ARGS%
